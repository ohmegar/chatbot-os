    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            {{-- <a href="/" class="xl:hidden">
                <img class="dark:hidden" src="{{ asset('/images/logo/logo.png') }}" alt="Logo DSS" />
                <img class="hidden dark:block" src="{{ asset('/images/logo/logo-dark.png') }}" alt="Logo dss" />
            </a> --}}
            <a href="{{ url('/dashboard') }}" class="xl:hidden flex items-center gap-2.5">
                <div
                    class="w-8 h-8 rounded-lg bg-brand-500 flex items-center justify-center text-white shadow-sm shadow-brand-500/20">
                ...
                <span class="font-bold text-base tracking-wide text-gray-800 dark:text-white">
                    Chatbot OS
                </span>
            </a>
