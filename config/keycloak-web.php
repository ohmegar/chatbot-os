...
return [
    ...
    |--------------------------------------------------------------------------
    | ปรับเป็น false เพื่อไม่ให้ package พยายาม insert/update หรือ query ตาราง users
    */
    'save_user' => false,

    /*
    |--------------------------------------------------------------------------
    | User Provider Custom Param
    |--------------------------------------------------------------------------
    | กำหนดให้ดึงข้อมูล User จาก Token มาจำไว้ใน Session แทน
    */
    'user_provider_custom_param' => null,
